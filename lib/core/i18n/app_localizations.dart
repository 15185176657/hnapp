...
class AppLocalizations {
  ...
  static const Map<String, Map<String, String>> _values = {
    ...
    'ja': {
      ...
      'dashboardSubtitle':
          '日々の判断に必要な電力・バッテリー・アラートの状態をわかりやすく表示。',
      'demoScenario': 'デモシナリオ',
      'weakNetworkTitle': '電波が弱い',
      'weakNetworkMessage': '最新の取得成功データを表示しています。下に引いて再試行してください。',
      'remainingHours': '現在の負荷では、システムはあと約 {hours} 時間電力を供給できます。',
      'deviceOfflineHint': 'デバイスがオフラインです。ゲートウェイの電源と信号を確認してください。',
      'metricPvPower': '太陽光発電出力',
      'metricPvPowerCaption': '現在の太陽光出力',
      'metricLoadPower': '負荷電力',
      'metricLoadPowerCaption': '現在の家庭消費電力',
      'metricBatterySoc': 'バッテリー残量',
      'metricBatterySocCaption': '残りのバッテリーレベル',
      'metricTodayGenerated': '本日の発電量',
      'todayUsedCaption': '本日の消費 {value} kWh',
      'lastUpdated': '最終更新 {time}',
      'statusNormal': '正常',
      'statusCharging': '充電中',
      'statusDischarging': '放電中',
      'statusLowBattery': 'バッテリー残量低下',
      'statusActionNeeded': '対応が必要',
      'statusOffline': 'オフライン',
      'dataTitle': 'エネルギーデータ',
      'dataSubtitle': '日々のエネルギー計画のための発電・消費トレンド。',
      'savedDataTitle': '最後に保存したデータ',
      'savedDataMessage': '更新に失敗したため、以前のグラフを保持しています。',
      'metricTodayUsed': '本日の消費量',
      'metricTotalGenerated': '総発電量',
      'metricTotalUsed': '総消費量',
      'monthCaption': '月間 {value} kWh',
      'todayTrend': '本日のトレンド',
      'todayTrendSubtitle': '太陽光発電 vs 家庭消費',
      'legendGeneration': '発電',
      'legendConsumption': '消費',
      'alertsTitle': '通知',
      'alertsSubtitle': 'バッテリー残量低下・故障・過負荷への明確な対応。',
      'segmentCurrent': '現在',
      'segmentHistory': '履歴',
      'noAlertsTitle': 'アラートなし',
      'noAlertsMessage':
          'システムは正常に動作しています。夜間前にバッテリーを確認してください。',
      'resolved': '解決済み',
      'severityWarning': '警告',
      'severityCritical': '重大',
      'severityInfo': '情報',
      'actionPrefix': '対応: {action}',
      'daysAgo': '{count}日前',
      'hoursAgo': '{count}時間前',
      'minutesAgo': '{count}分前',
      'profileTitle': 'マイシステム',
      ...
      'otpPlaceholder': '電話/メールOTP（デモ用）',
      'signOut': 'ログアウト',
      'signIn': 'ログイン',
      'bindDevice': 'デバイスを連携',
      'bindDeviceHintEmpty': 'QRコードをスキャンまたはSNを入力',
      'bindDeviceHintSerial': 'SN {serial}',
      'bindingReserved': 'デバイス連携フローはAPI連携用に予約済みです。',
      'pvCapacity': '太陽光容量',
      'batteryCapacity': 'バッテリー容量',
      'firmware': 'ファームウェア',
      'language': '言語',
      'languageSystemDefault': 'システムデフォルト',
      'alertNotifications': 'アラート通知',
      'alertNotificationsSubtitle': 'バッテリー残量低下・故障・過負荷',
      'privacyTitle': 'プライバシーとユーザー規約',
      'privacySubtitle': 'リリース準備用の予約ページ',
      'privacyPlaceholder': '規約ページのプレースホルダー。',
      'granularityDay': '日',
      'granularityWeek': '週',
      'granularityMonth': '月',
    ...
    'ko': {
      ...
      'dashboardSubtitle':
          '일상적인 결정을 위한 전력, 배터리, 알림 상태를 명확히 표시합니다.',
      'demoScenario': '데모 시나리오',
      'weakNetworkTitle': '네트워크 불안정',
      'weakNetworkMessage':
          '마지막으로 성공한 데이터를 표시합니다. 아래로 당겨 재시도하세요.',
      'remainingHours':
          '현재 부하 기준으로 시스템은 약 {hours}시간 동안 전력을 공급할 수 있습니다.',
      'deviceOfflineHint': '장치가 오프라인입니다. 게이트웨이 전원과 신호를 확인하세요.',
      'metricPvPower': '태양광 출력',
      'metricPvPowerCaption': '현재 태양광 출력',
      'metricLoadPower': '부하 전력',
      'metricLoadPowerCaption': '현재 가정 소비 전력',
      ...
      'statusOffline': '오프라인',
      'dataTitle': '에너지 데이터',
      'dataSubtitle': '일상적인 에너지 계획을 위한 발전 및 소비 트렌드.',
      'savedDataTitle': '마지막으로 저장된 데이터',
      'savedDataMessage': '새로 고침 실패로 인해 이전 차트를 유지하고 있습니다.',
      'metricTodayUsed': '오늘 사용량',
      'metricTotalGenerated': '총 발전량',
      'metricTotalUsed': '총 소비량',
      ...
      'alertsTitle': '알림',
      'alertsSubtitle': '배터리 부족, 오류, 과부하에 대한 명확한 조치.',
      'segmentCurrent': '현재',
      'segmentHistory': '기록',
      'noAlertsTitle': '알림 없음',
      'noAlertsMessage':
          '시스템이 정상적으로 작동 중입니다. 밤 이전에 배터리를 확인하세요.',
      'resolved': '해결됨',
      'severityWarning': '경고',
      'severityCritical': '심각',
      'severityInfo': '정보',
      ...
      'profileTitle': '내 시스템',
      'profileSubtitle': '계정, 장치, 언어 및 알림 설정.',
      'accountSignedIn': '데모 계정 로그인됨',
      'accountNotSignedIn': '로그인하지 않음',
      'otpPlaceholder': '전화/이메일 OTP (데모용)',
      'signOut': '로그아웃',
      'signIn': '로그인',
      'bindDevice': '장치 연결',
      'bindDeviceHintEmpty': 'QR 코드 스캔 또는 SN 입력',
      'bindDeviceHintSerial': 'SN {serial}',
      'bindingReserved': '장치 연결 흐름은 API 통합을 위해 예약되어 있습니다.',
      'pvCapacity': '태양광 용량',
      ...
      'alertNotificationsSubtitle': '배터리 부족, 오류, 과부하',
      'privacyTitle': '개인정보 및 사용자 계약',
      'privacySubtitle': '출시 준비를 위해 예약된 페이지',
